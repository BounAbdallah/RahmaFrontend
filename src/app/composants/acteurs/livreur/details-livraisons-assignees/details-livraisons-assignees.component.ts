...
@Component({
  selector: 'app-details-livraisons-assignees',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './details-livraisons-assignees.component.html',
  styleUrls: ['./details-livraisons-assignees.component.css']
})
export class DetailsLivraisonsAssigneesComponent {
